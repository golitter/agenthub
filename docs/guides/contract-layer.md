...
│   ├── conflict-recovery.yaml # Orchestrator 冲突人工接管与恢复动作契约
│   └── integration-result.yaml # taskctl merge 与 Orchestrator 间的结构化集成事实
...
每个生成文件首行包含 `Code generated by make generate. DO NOT EDIT.` 生成注释（Python 为 `#`、TypeScript/Go 为 `//`），手动修改会被下次生成覆盖。
